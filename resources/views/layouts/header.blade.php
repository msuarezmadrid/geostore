  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{url('items')}}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>GEOSTORE</b></span>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ url('/profiles') }}" class="btn btn-default btn-flat">Perfil</a>
                </div>
