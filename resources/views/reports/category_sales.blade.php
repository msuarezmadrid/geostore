                ...
                <div class="box box-primary box-solid flat">
                    ...
                    <div class="box-body">
                        <div class="col-xs-12" id="div_seller">
                            <table id="categories" class="display nowrap table table-bordered table-hover" cellspacing="0" width="100%" style="text-align: left;">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Categoria</th>
...
@section('js')
    ...
    <script>
        ...
        function showMovements(categoryId) {
            category_id = categoryId;
            $('#box_movements').modal('show');
        }
        function exports(categoryId) {
            ...
            //TO-DO
            AWApi.download('{{ url('/api/reports/sales/export/categories') }}?'+$.param(data));
        }
    ...
    function disable_payment_methods_not_allowed(){
        ...
        $(document).ready(function() {
            ...
            table_sales = $('#categories').DataTable( {
                "language": {
                ...
                "ajax": function (data, callback, settings) {
                    ...
                    AWApi.get('{{ url('/api/reports/sales/resume/categories' ) }}?'+$.param(data), function (response) {
                ...
                //"scrollX": true,
                "columns": [
                    {"data":"categories_id", "visible": false},
                    {"data":"name"},
                    ...
                    {"data":"id","class":"text-center",  "render" : function(a,b,c,d){
                        return `
                        <button class="btn" onClick="showMovements(${c.categories_id})" ><i class="fa fa-eye"></i></button>
                        <button class="btn" onClick="exports(${c.categories_id})" ><i class="fa fa-file-excel-o"></i></button>
                        `;
                    }}
                ],
            ...
            table_movements = $('#movements').DataTable( {
                ...
                "ajax": function (data, callback, settings) {
                    ...
                    data.filters       = filters;
                    AWApi.get('{{ url('/api/reports/sales/movements/category' ) }}?'+$.param(data), function (response) {
                        callback({
                ...
                "columns": [
                    ...
                    {"data":"price", "render":function(a,b,c,d) {
                        return '$'+formatMoney(a, 'CL');
                    }},
                    {"data":"folio"},
