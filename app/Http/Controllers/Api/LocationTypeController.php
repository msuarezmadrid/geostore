...
class LocationTypeController extends ApiController
{
    ...
    public function index(Request $request)
    {
        ...
        if($with == null){
            ...
            $data->location_types = $datas->get();
			$data->recordsFiltered = count($data->location_types);
    ...
    public function destroy(Request $request, $id)
    {
        try{
            ...
            $locs = Location::where('location_type_id', $id)->get();

            if($locs !== null){
                $data = new \stdClass();
                $errors = "El Tipo de Almacén está siendo utilizado. No puede ser eliminado";
                $data->errors = $errors;
